...
export function getAsynArea_vchannel(params) {
  return request.get("collect/device_basechannel/listbasechannel.do", {
    params,
  })
}
...
export function getDeviceAlterInfo(params) {
  return request.get(base + "/deviceAlter/info", { params })
}
...
export function deviceAlter(data) {
  return request.post(base + "/deviceAlter/alter", data)
}
...
export function alarmConditionDel(data) {
  return request.post(base + "/device_devalearminfo/AlarmConditionDel.do", data)
}
...
export function alarmConditionUpd(data) {
  return request.post(base + "/device_devalearminfo/AlarmConditionUpd.do", data)
}
export function vchannel_edit(data) {
  return request.post(base + "/device_vchannel/edit.do", data)
}
export function alarmConditionAdd(data) {
  return request.post(base + "/device_devalearminfo/AlarmConditionAdd.do", data)
}
...
export function base_copyAlarmCondition(data) {
  return request.post(base + "/device_basechannel/copyBaseAlarmCondition", data)
}
