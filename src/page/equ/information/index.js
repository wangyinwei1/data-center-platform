...
import RumorModal from "./rumorContent.js"
...
class Information extends Component {
  ...
  componentDidUpdate() {
    const {
      informationStore: { showIconIndex },
    } = this.props
  ...
  onRealtimeCancel() {
    ...
    const {
      informationStore: { getTable, tableParmas },
    } = this.props
  ...
  rumorClick(item, e) {
    ...
    informationStore.getDeviceAlterInfo(params).then((data) => {
      data &&
        this.setState({
          rumorShow: true,
        })
  ...
  addLevelOneClick(item) {
    const {
      informationStore: { currentDeviceChange },
    } = this.props
  ...
  onEditOk() {
    ...
    if (hasError[0]) {
      ...
      const {
        informationStore: { save, editSave, currentDevice },
      } = this.props
      const F_DeviceID = { F_DeviceID: currentDevice }
  ...
  onBatchOk() {
    const {
      informationStore: { fsuDevsEnabledOnOff, fsuDelectAll },
    } = this.props
    ...
    return (
      <div className={styles["information_wrap"]}>
        ...
        <div className={styles["information_ct"]}>
          ...
          {/*谣调 */}
          <RumorModal
            rumorShow={this.state.rumorShow}
            onRumorCancel={this.onRumorCancel}
          />
          <ControlModal
            width={850}
